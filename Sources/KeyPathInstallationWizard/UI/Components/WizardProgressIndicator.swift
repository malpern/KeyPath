...
public struct WizardActivityIndicator: View {
    public let message: String?
    public let width: CGFloat
    public let height: CGFloat

    public init(message: String? = nil, width: CGFloat = 200, height: CGFloat = 6) {
...
public struct WizardProgressIndicator: View {
    ...
    public init(title: String, progress: Double = 0.0, isIndeterminate: Bool = false) {
        self.title = title
...
public struct WizardOperationProgress: View {
