...
public struct WizardHeroSection: View {
    // MARK: - Configuration
    ...
    public let overlaySize: OverlaySize
    public let title: String
    public let subtitle: String
    public let actionButtonTitle: String?
    public let actionButtonAction: (() -> Void)?
    public let iconTapAction: (() -> Void)?
...
public struct InlineStatusView: View {
    public let status: WizardDesign.ActionStatus
    public let message: String

    public init(status: WizardDesign.ActionStatus, message: String) {
        self.status = status
