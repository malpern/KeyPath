...
public struct WizardErrorDisplay: View {
    public let error: WizardError
    public let onRetry: (() -> Void)?
    public let onDismiss: (() -> Void)?

    public init(error: WizardError, onRetry: (() -> Void)? = nil, onDismiss: (() -> Void)? = nil) {
        self.error = error
...
public struct WizardErrorToast: View {
    public let error: WizardError
...
public struct WizardErrorBanner: View {
    public let error: WizardError
    public let onRetry: (() -> Void)?
