...
public final class PrivilegedExecutor: @unchecked Sendable {
    // MARK: - Singleton

    /// Shared instance for privileged command execution.
    /// Thread-safe: The class has no mutable state.
    public static let shared = PrivilegedExecutor()
    ...
    public func executeWithPrivileges(command: String, prompt: String) -> (success: Bool, output: String) {
    ...
    /// - Returns: Tuple of (success, output)
    public func executeWithSudo(command: String) -> (success: Bool, output: String) {
        AppLogger.shared.log(
    ...
    public func executeWithOsascript(command: String, prompt: String) -> (success: Bool, output: String) {
    ...
    public func testAdminDialog() -> Bool {
