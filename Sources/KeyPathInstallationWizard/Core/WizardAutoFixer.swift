...
public protocol WizardInstallerEngineProtocol: AnyObject, Sendable {
...
public class WizardAutoFixer {
    private let kanataManager: any RuntimeCoordinating
    ...
    @MainActor
    public func analyzeStartupError(_ error: String) -> (issue: WizardIssue?, canAutoFix: Bool) {
        let analysis = WizardPermissionAnalyzing.analyzeKanataError(error)
    ...
    @MainActor
    public func resetEverything() async -> Bool {
