...
public enum IssueSeverityInstallationStatusMapper {
    ...
    public static func installationStatus(for issues: [WizardIssue]) -> InstallationStatus {
    ...
    public static func highestSeverity(in issues: [WizardIssue]) -> WizardIssue.IssueSeverity? {
