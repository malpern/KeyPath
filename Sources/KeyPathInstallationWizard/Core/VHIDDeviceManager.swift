...
public final class VHIDDeviceManager: @unchecked Sendable {
    ...
    public nonisolated(unsafe) static let stepProgress = PassthroughSubject<String, Never>()
    ...
    public static var requiredDriverVersionString: String {
    ...
    public func detectInstallation() -> Bool {
    ...
    public func detectActivation() -> Bool {
        let fileManager = Foundation.FileManager()
    ...
    public func securityPreflightIssues() async -> [String] {
    ...
    public func detectRunning() async -> Bool {
    ...
    public func getDaemonPIDs() async -> [String] {
    ...
    public func detectConnectionHealth() async -> Bool {
    ...
    public func hasVersionMismatch() -> Bool {
    ...
    public func activateManager() async -> Bool {
    ...
    public func uninstallAllDriverVersions() async -> Bool {
    ...
    public func downloadAndInstallCorrectVersion() async -> Bool {
        AppLogger.shared.log(
    ...
    public func getDetailedStatus() async -> VHIDDeviceStatus {
...
public struct VHIDDeviceStatus {
    public let managerInstalled: Bool
    public let managerActivated: Bool
    public let daemonRunning: Bool
    public let connectionHealthy: Bool
