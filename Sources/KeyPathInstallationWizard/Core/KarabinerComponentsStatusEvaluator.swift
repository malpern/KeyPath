...
public enum KarabinerComponent {
...
public enum KarabinerComponentsStatusEvaluator {
    ...
    public static func getIndividualComponentStatus(
    ...
    public static func getKarabinerRelatedIssues(from issues: [WizardIssue]) -> [WizardIssue] {
    ...
    public static func hasAutoFixableIssues(in issues: [WizardIssue]) -> Bool {
