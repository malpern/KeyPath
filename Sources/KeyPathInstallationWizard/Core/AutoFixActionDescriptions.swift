...
public enum AutoFixActionDescriptions {
    public static func describe(_ action: AutoFixAction) -> String {
        switch action {
    ...
    public static func errorMessage(for action: AutoFixAction) -> String {
        switch action {
        case .installRequiredRuntimeServices:
