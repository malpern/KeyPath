...
class PermissionService {
    ...
    /// Legacy method stub - use Oracle instead
    func verifyKanataFunctionalPermissions(at _: String) -> (hasInputMonitoring: Bool, hasAccessibility: Bool, confidence: String, verificationMethod: String, hasAllRequiredPermissions: Bool, errorDetails: [String]) {
    ...
    static func analyzeKanataError(_: String) -> (isPermissionError: Bool, description: String, suggestedFix: String?) {
        (isPermissionError: false, description: "Oracle system - see permission snapshot for details", suggestedFix: "Use Permission Oracle for diagnostics")
    }
