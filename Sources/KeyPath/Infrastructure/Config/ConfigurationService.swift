...
public struct KanataConfiguration: Sendable {
    ...
    public static func generateFromMappings(_ mappings: [KeyMapping]) -> String {
        ...
        ;;
        ;; macOS Function Key Workaround:
        ;; When Kanata is active, macOS sends F1-F12 instead of media keys.
        ;; We map F-keys to their media functions to preserve default macOS behavior.
        ;; See: https://github.com/jtroo/kanata/issues/1141
