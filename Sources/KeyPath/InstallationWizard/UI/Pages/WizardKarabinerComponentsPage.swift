...
struct WizardKarabinerComponentsPage: View {
  ...
  private func getComponentDescription(for issue: WizardIssue) -> String {
    switch issue.title {
    case "VirtualHIDDevice Manager Not Activated":
      return "The VirtualHIDDevice Manager needs to be activated for virtual HID functionality"
    case "VirtualHIDDevice Daemon":
    ...
    case "Driver Extension Disabled":
      return "Karabiner driver extension needs to be enabled in System Settings"
    case "Background Services Disabled":
      return "Karabiner services need to be added to Login Items for automatic startup"
    default:
