...
class LaunchDaemonInstaller {
    ...
    // Service paths
    private static let kanataBinaryPath = "/usr/local/bin/kanata"
    ...
    func createKanataLaunchDaemon() -> Bool {
        ...
        let plistContent = generateKanataPlist()
    ...
    private func generateKanataPlist() -> String {
        return """
        ...
        <dict>
            ...
            <array>
                <string>\(Self.kanataBinaryPath)</string>
                <string>--cfg</string>
