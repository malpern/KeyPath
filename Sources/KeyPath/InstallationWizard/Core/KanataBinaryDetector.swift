    ...
    struct DetectionResult {
        ...
        var statusMessage: String {
            ...
            case .systemInstalled:
                return "System Installation Ready"
        ...
        var detailedDescription: String {
            switch status {
            case .systemInstalled:
                return "Kanata is properly installed at system location and ready for LaunchDaemon use"
            case .bundledAvailable:
                return "Kanata binary is bundled with the app and can be installed to system location"
            case .bundledUnsigned:
                return "Kanata binary found but lacks proper Developer ID signature"
            case .missing:
                return "No kanata binary found in expected locations"
            }
        }
    }
