...
class KanataConfigManager {
  ...
  enum ConfigTemplate: String, CaseIterable {
    ...
    var description: String {
      switch self {
      case .minimal:
        return "Single mapping: Caps Lock to Escape"
      case .standard:
        return "Common remappings for general productivity"
      case .advanced:
        return "Complex mappings with layers and modifiers"
      case .vim:
        return "Optimized for Vim/Neovim users"
      case .emacs:
    ...
    var mappings: [KeyMapping] {
      switch self {
      case .minimal:
        return [KeyMapping(input: "caps", output: "esc")]
      case .standard:
        return [
