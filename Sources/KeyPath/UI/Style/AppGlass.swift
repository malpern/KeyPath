...
extension View {
    func appSurfaceCard(radius: CGFloat = 12) -> some View { modifier(AppSurfaceCard(radius: radius)) }
}
...
extension View {
    func appButtonGlass(tint: Color = .accentColor, radius: CGFloat = 8, active: Bool = true) -> some View {
