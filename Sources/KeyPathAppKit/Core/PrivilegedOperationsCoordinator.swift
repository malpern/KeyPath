...
final class PrivilegedOperationsCoordinator {
    ...
    func installAllLaunchDaemonServices(
        ...
        AppLogger.shared.log("🔐 [PrivCoordinator] Installing all LaunchDaemon services via SMAppService")
    ...
    func installAllLaunchDaemonServices() async throws {
        AppLogger.shared.log("🔐 [PrivCoordinator] Installing all LaunchDaemon services (using preferences) via SMAppService")
        // Always use SMAppService path for Kanata
