...
public final class ActionDispatcher {
    ...
    /// Actions: mission-control, spotlight, dictation, dnd, launchpad, notification-center, siri, repair-helper
    private func handleSystem(_ uri: KeyPathActionURI) -> ActionDispatchResult {
        ...
        default:
            let message = "Unknown system action: \(action). Supported: mission-control, spotlight, dictation, dnd, launchpad, notification-center, siri, repair-helper"
            AppLogger.shared.log("⚠️ [ActionDispatcher] \(message)")
            onError?(message)
