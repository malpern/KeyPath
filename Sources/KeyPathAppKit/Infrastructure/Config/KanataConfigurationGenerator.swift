...
public struct KanataConfiguration: Sendable {
    ...
    public static func generateFromCollections(
        ...
        // Extract max require-prior-idle value from enabled collections (defcfg-level option)
        ...
        let requirePriorIdleLine = requirePriorIdleMs > 0
            ? "\n  require-prior-idle \(requirePriorIdleMs)"
            : ""
        ...
        if requirePriorIdleMs > 0 {
            defcfgLines.append("  require-prior-idle \(requirePriorIdleMs)")
        }
