...
extension RuleCollectionRow {
  @ViewBuilder
  fileprivate func iconView(for icon: String) -> some View {
  ...
  fileprivate var activationDescription: String? {
  ...
  fileprivate func mappingDescription(for mapping: KeyMapping) -> String {
  ...
  fileprivate func prettyKeyName(_ raw: String) -> String {
