...
struct LabelMetadata {
    ...
    ///
    /// Delegates to SystemActionInfo as the single source of truth for SF symbols.
    /// Only handles edge cases not covered by SystemActionInfo (e.g., hotkey combos).
    static func sfSymbol(forOutputLabel label: String) -> String? {
        ...
        // This handles all system actions and media keys
