![Launching Apps](header-action-uri.png)
...
| **Script** | backup.sh, deploy.py | Runs the script (with [safety protections](help:privacy)) |
...
<!-- screenshot: id="action-uri-launcher-drawer" method="snapshot" view="LauncherDrawerView" state="drawer:open,shortcuts:populated" -->
...
- **[What You Can Build](help:use-cases)** — See app launching in context with window tiling, shortcuts, and more
- **[Windows & App Shortcuts](help:window-management)** — App-specific keymaps and window snapping
- **[One Key, Multiple Actions](help:tap-hold)** — How the Hyper key's tap-hold behavior works
- **[Keyboard Concepts](help:concepts)** — Background on layers and modifiers
- **[Action URI Reference](help:action-uri-reference)** — Technical deep link reference for integrating with Raycast, Alfred, and scripts
