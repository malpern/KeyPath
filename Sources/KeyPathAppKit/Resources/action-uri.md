...
- **[What You Can Build](help:use-cases)** — See Action URIs in context: Hyper key launchers, window tiling, leader sequences
- **[Window Management](help:window-management)** — App-specific keymaps and window snapping using Action URIs
- **[Keyboard Concepts](help:concepts)** — Background on layers, modifiers, and chords
- **[Kanata documentation](https://github.com/jtroo/kanata/blob/main/docs/config.adoc#push-msg)** — Kanata's `push-msg` reference ↗
- **[FAQ](https://keypath-app.com/faq)** — Common questions about configuration and TCP
