![Numpad Layer](header-numpad-layer.png)
...
- **[Navigate Text Like a Keyboard Ninja](help:vim-navigation)** — The foundation layer (required for numpad)
- **[Choose Your Leader Key](help:leader-key)** — Change which key starts the activation sequence
