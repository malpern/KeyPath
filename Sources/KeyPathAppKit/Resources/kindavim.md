![Full Vim Modes on macOS](header-use-cases.png)
...
- **[What You Can Build](help:use-cases)** — See all the things KeyPath can do
- **[Shortcuts Without Reaching](help:home-row-mods)** — Combine KindaVim with home row modifiers
- **[One Key, Multiple Actions](help:tap-hold)** — Learn how Leader key tap-hold works
