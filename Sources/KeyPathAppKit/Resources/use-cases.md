...
New to keyboard customization? Read [Keyboard Concepts](help:concepts) first.
...
**How to set it up:** Open the **Launchers** tab, click **Add Shortcut**, choose your key and target. See the [Launching Apps guide](help:action-uri) for the full walkthrough.
...
**How to set it up:** Enable the "Home Row Mods" pre-built rule in the Custom Rules tab. See the full [Shortcuts Without Reaching guide](help:home-row-mods).
...
**How to set it up:** Enable the "Window Snapping" pre-built rule, or create custom bindings. See the [Window Management guide](help:window-management).
...
**How to set it up:** Go to the **Custom Rules** tab, click **New Rule**, select the target app, and add your mappings. See the [Window Management guide](help:window-management).
...
**How to set it up:** Create a custom rule with a tap-hold key that activates a navigation layer on hold. See [One Key, Multiple Actions](help:tap-hold) for how dual-role keys work.
...
**Learn more:** [Alternative Layouts](help:alternative-layouts) · [Keyboard Layouts](help:keyboard-layouts)
