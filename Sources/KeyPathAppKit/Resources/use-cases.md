...
New to these ideas? Read [Keyboard Concepts](help:concepts) first.
...
**How to set it up:** Enable the "Home Row Mods" pre-built rule. See the full [Home Row Mods guide](help:home-row-mods).
...
KeyPath uses the [Action URI system](help:action-uri) to control windows directly from your keyboard config.
...
**How to set it up:** Add Safari (or any app) in the App-Specific Rules tab, then configure HJKL mappings. See the [Window Management guide](help:window-management).
...
- **[Your First Mapping](https://keypath-app.com/getting-started/first-mapping)** — Get started with a simple remap
- **[Home Row Mods](help:home-row-mods)** — Deep dive on the most popular technique
- **[Tap-Hold & Tap-Dance](help:tap-hold)** — Fine-tune your dual-role keys
- **[Action URIs](help:action-uri)** — Launch apps, URLs, and workflows from your keyboard
- **[Window Management](help:window-management)** — App-specific keymaps and window tiling
