![Auto-Shift Symbols](header-auto-shift.png)
...
<!-- screenshot: id="auto-shift-config" method="snapshot" view="AutoShiftCollectionView" state="timeout:180,protectFastTyping:on,allKeys:enabled" -->
...
Auto-Shift and [home row mods](help:home-row-mods) both use tap-hold behavior. They coexist well because they apply to different keys (HRM applies to letters, Auto-Shift to symbols). The "Protect Fast Typing" setting is shared — whichever feature sets a higher idle threshold wins.
...
- **[Shortcuts Without Reaching](help:home-row-mods)** — Home row mods for your letter keys (complementary to Auto-Shift for symbols)
- **[One Key, Multiple Actions](help:tap-hold)** — The tap-hold system that powers Auto-Shift under the hood
- **[Keyboard Concepts](help:concepts)** — Background on dual-role keys and timing
