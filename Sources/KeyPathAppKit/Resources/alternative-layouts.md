![Alternative Layouts](header-alternative-layouts.png)
...
That said, switching layouts is a commitment — expect weeks of slower typing before you regain speed. Many people find it worthwhile; others prefer to stay on QWERTY and use [Shortcuts Without Reaching](help:home-row-mods) or a [Hyper key](help:use-cases) instead.
...
5. **Combine with Home Row Mods.** [Shortcuts Without Reaching](help:home-row-mods) work with any layout — the modifier positions adapt to wherever the home row letters are.
