![Keyboard Layouts](header-keyboard-layouts.png)
...
You can combine any physical layout with any [logical keymap](help:alternative-layouts). For example, select "Corne" as your physical layout and "Colemak-DH" as your keymap to see Colemak-DH labels on a Corne board.
...
The **Corne** (42 keys) is the community favorite for a balance of minimalism and usability. Pair it with [Shortcuts Without Reaching](help:home-row-mods) and layers.
...
- **[Shortcuts Without Reaching](help:home-row-mods)** — Split-hand detection is a natural fit when your hands are physically separated. Cross-hand keypresses reliably activate modifiers.
- **Layers** — Smaller boards rely heavily on layers. KeyPath's [tap-hold](help:tap-hold) system makes layer switching smooth and customizable.
- **[Alternative layouts](help:alternative-layouts)** — Colemak-DH was specifically designed with columnar keyboards in mind. The DH modification moves D and H to more comfortable positions on non-staggered boards.
...
- **[Keyboard Concepts](help:concepts)** — Layers, modifiers, and tap-hold fundamentals
