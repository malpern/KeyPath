![Key Repeat Control](header-key-repeat-control.png)
...
- **[Navigate Text Like a Keyboard Ninja](help:vim-navigation)** — Combine fast arrows with home-row navigation
- **[Keyboard Concepts](help:concepts)** — Background on how KeyPath controls key behavior
