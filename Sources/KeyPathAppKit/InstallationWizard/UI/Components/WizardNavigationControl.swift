        ...
        if navigationCoordinator.canNavigateBack || navigationCoordinator.canNavigateForward {
            HStack(spacing: 0) {
                ...
                Button(action: {
                    ...
                    Image(systemName: "chevron.left")
                        ...
                        .foregroundStyle(
                            navigationCoordinator.canNavigateBack ? Color.primary : Color.secondary.opacity(0.4)
                        )
                ...
                Button(action: {
                    ...
                    Image(systemName: "chevron.right")
                        ...
                        .foregroundStyle(
                            navigationCoordinator.canNavigateForward ? Color.primary : Color.secondary.opacity(0.4)
                        )
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 5)
                    .stroke(
                        isHovering ? Color.secondary.opacity(0.4) : Color.secondary.opacity(0.2), lineWidth: 0.5
                    )
            )
            .onHover { hovering in
    ...
    var body: some View {
        Button {
            ...
            Image(systemName: "xmark")
                ...
                .foregroundStyle(Color(NSColor.secondaryLabelColor)) // More subtle symbol color
