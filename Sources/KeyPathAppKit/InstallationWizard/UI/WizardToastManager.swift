...
enum WizardToast: Equatable {
  ...
  var message: String {
    ...
    case .success(let message), .error(let message), .info(let message):
      message
    case .actionable(let message, _, _, _):
      message
    }
  }
  ...
  var icon: String {
    ...
    case .actionable(_, let icon, _, _): icon
    }
  }
  ...
  var style: ToastStyle {
    ...
    case .error: .error
    case .info: .info
    case .actionable(_, _, let style, _): style
    }
  }
  ...
  var actionTitle: String? {
    ...
    case .actionable(_, _, _, let actionTitle): actionTitle
    }
  }
}
