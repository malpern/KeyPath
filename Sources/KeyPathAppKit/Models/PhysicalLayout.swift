...
struct PhysicalLayout {
    ...
    static let macBookUS: PhysicalLayout = {
        ...
        let keySpacing: Double = 0.1  // Gap between keys
        let rowSpacing: Double = 1.2  // Vertical spacing between row centers
        let standardKeyWidth: Double = 1.0
        let standardKeyHeight: Double = 1.0
        ...
        let arrowXStart: Double = 11.0  // Approximate position below right shift
