...
enum JISPositionTable {
    ...
    static func keyMapping(row: Int, col: Int) -> (keyCode: UInt16, label: String)? {
        ...
        case (0, 10): (27, "-")
        case (0, 11): (24, "=")
        case (0, 12): (51, "\u{232B}") // Backspace
        // Row 1: Top row - JIS has Yen key instead of backslash
        case (1, 0): (48, "\u{21E5}") // Tab
        case (1, 1): (12, "q")
        case (1, 2): (13, "w")
        case (1, 3): (14, "e")
        case (1, 4): (15, "r")
        ...
        case (1, 11): (33, "[")
        case (1, 12): (30, "]")
        case (1, 13): (0x5D, "\u{00A5}") // Yen key (kVK_JIS_Yen)
        // Row 2: Home row - JIS has L-shaped Enter (like ISO)
        case (2, 0): (57, "\u{21EA}") // Caps Lock
        case (2, 1): (0, "a")
        case (2, 2): (1, "s")
        case (2, 3): (2, "d")
        case (2, 4): (3, "f")
        ...
        case (2, 10): (41, ";")
        case (2, 11): (39, "'")
        case (2, 12): (36, "\u{21A9}") // Enter (L-shaped, top part)
        case (2, 13): (36, "\u{21A9}") // Enter (L-shaped, continuation)
        // Row 3: Bottom row - JIS has Underscore key between / and Right Shift
        case (3, 0): (56, "\u{21E7}") // Left Shift
        case (3, 1): (6, "z")
        case (3, 2): (7, "x")
        case (3, 3): (8, "c")
        case (3, 4): (9, "v")
        ...
        case (3, 12): (60, "\u{21E7}") // Right Shift
        // Row 4: Modifier row - JIS has Eisu and Kana keys flanking shorter spacebar
        case (4, 0): (59, "\u{2303}") // Left Control
        case (4, 1): (58, "\u{2325}") // Left Option/Alt
        case (4, 2): (55, "\u{2318}") // Left Command/Win
        case (4, 3): (0x66, "\u{82F1}\u{6570}") // Eisu key (kVK_JIS_Eisu)
        case (4, 4): (49, "\u{2423}") // Space (shorter than ANSI)
        case (4, 5): (0x68, "\u{304B}\u{306A}") // Kana key (kVK_JIS_Kana)
        case (4, 6): (54, "\u{2318}") // Right Command/Win
        case (4, 7): (61, "\u{2325}") // Right Option/Alt
        case (4, 8): (102, "\u{2303}") // Right Control
        ...
        case (3, 13): (126, "\u{25B2}") // Up Arrow
        case (3, 14): (123, "\u{25C0}") // Left Arrow
        case (3, 15): (125, "\u{25BC}") // Down Arrow
        case (3, 16): (124, "\u{25B6}") // Right Arrow
        // Navigation keys
        case (3, 17): (115, "Home")
        case (3, 18): (116, "PgUp")
        case (3, 19): (119, "End")
