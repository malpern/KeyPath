...
private func getPageDotState(for page: WizardPage, currentPage: WizardPage) -> PageDotState {
    ...
    guard let pageIndex = allPages.firstIndex(of: page),
          let currentIndex = allPages.firstIndex(of: currentPage) else {
        return .upcoming
    }
...
extension WizardNavigationCoordinator {
    ...
    func setUserInteractionMode(_ enabled: Bool) {
        // Mock implementation
    }
    ...
    func markPageCompleted(_ page: WizardPage) {
        // Mock implementation
    }
    
    func isPageCompleted(_ page: WizardPage) -> Bool {
        // Mock implementation
        false
    }
