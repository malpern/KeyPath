...
final class DeviceSwitchConfigTests: XCTestCase {
    ...
    func testKeyWithoutDeviceOverrides_EmitsNormally() {
        // A mapping with no deviceOverrides should not produce a switch expression.
        // This test verifies the data model default — deviceOverrides is nil.
