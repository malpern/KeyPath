...
final class FlexibleUIAutomationTests: XCTestCase {
    ...
    func testDynamicMappingGeneration() async throws {
        ...
        let numberSuccessCount = numberResults.filter { $0.success }.count
        ...
        let letterSuccessCount = letterResults.filter { $0.success }.count
        ...
        let functionSuccessCount = functionResults.filter { $0.success }.count
    ...
    func testFrameworkConfiguration() async throws {
        ...
        let _ = await automationFramework.automateKeyMapping(testMapping)
