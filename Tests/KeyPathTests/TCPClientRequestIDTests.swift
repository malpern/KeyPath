...
final class TCPClientRequestIDTests: XCTestCase {
    ...
    func testRequestIDParsing() throws {
        ...
        let status = try JSONDecoder().decode(
            KanataTCPClient.TcpStatusInfo.self, from: statusPayloadData
        )
