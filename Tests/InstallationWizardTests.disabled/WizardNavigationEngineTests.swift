...
class WizardNavigationEngineTests: XCTestCase {
    ...
    func testNavigationPriorityAccessibilityFourth() {
        ...
        XCTAssertEqual(page, .accessibility, "Should navigate to accessibility when no input monitoring issues")
    }
    ...
    func testProgressDescription() {
        ...
        for (state, expectedDescription) in descriptions {
            ...
            XCTAssertEqual(actualDescription, expectedDescription, "Description for \(state) should match")
        }
    }
    ...
    func testSummaryButtonTextVariation() {
        ...
        let serviceNotRunningButtonText = engine.primaryButtonText(for: .summary, state: .serviceNotRunning)
        ...
        XCTAssertEqual(serviceNotRunningButtonText, "Start Kanata Service", "Service not running should show 'Start Kanata Service'")
        XCTAssertEqual(readyButtonText, "Start Kanata Service", "Ready state should show 'Start Kanata Service'")
    }
