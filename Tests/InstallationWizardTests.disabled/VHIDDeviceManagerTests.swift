...
class MockVHIDDeviceManager: VHIDDeviceManager {
    ...
    init(installed: Bool = false, activated: Bool = false, running: Bool = false, activationResult: Bool = false) {
...
final class MockVHIDDeviceManagerTests: XCTestCase {
    ...
    func testMockVHIDDeviceManager_ActivationSuccess() async {
        let mockManager = MockVHIDDeviceManager(installed: true, activated: false, running: false, activationResult: true)
    ...
    func testMockVHIDDeviceManager_ActivationFailure() async {
        let mockManager = MockVHIDDeviceManager(installed: false, activated: false, running: false, activationResult: false)
