...
final class SystemRequirementsTests: XCTestCase {
    ...
    func testDetectMacOSVersion_ReturnsValidVersion() {
        ...
        XCTAssertGreaterThanOrEqual(components.count, 2, "Version should have at least major.minor components")
    ...
    func testDriverType_DisplayNames() {
        XCTAssertEqual(SystemRequirements.DriverType.driverKit.displayName, "DriverKit VirtualHIDDevice")
        XCTAssertEqual(SystemRequirements.DriverType.kernelExtension.displayName, "Kernel Extension VirtualHIDDevice")
    ...
    func testSystemRequirements_IntegrationWithSystemStateDetector() {
        ...
        Task {
            ...
            XCTAssertTrue(hasSystemRequirementIssues, "Should always include system requirement information")
            expectation.fulfill()
        }
...
class MockSystemRequirements: SystemRequirements {
    ...
    init(version: MacOSVersion = .modern(version: "14.0.0"), isCompatible: Bool = true, issues: [String] = [], recommendations: [String] = []) {
