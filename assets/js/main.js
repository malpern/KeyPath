...
(function() {
    ...
    if (document.body.classList.contains('parchment-theme')) {
        document.querySelectorAll('[data-kp-body] blockquote, .doc-content blockquote, .content blockquote').forEach(bq => {
...
`;
    ...
    document.querySelectorAll('[data-kp-body], .doc-content, .content').forEach((content) => {
