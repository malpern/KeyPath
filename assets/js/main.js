...
(function() {
    ...
    if (document.body.classList.contains('parchment-theme')) {
        document.querySelectorAll('main .content-wrapper > section blockquote, .doc-content blockquote, .content blockquote').forEach(bq => {
...
`;
    ...
    document.querySelectorAll('main .content-wrapper > section, .doc-content, .content').forEach((content) => {
