...
(function() {
    ...
    if (document.body.classList.contains('parchment-theme')) {
        document.querySelectorAll('.kp-article blockquote, .doc-content blockquote, .content blockquote').forEach(bq => {
...
`;
    ...
    document.querySelectorAll('.kp-article, .doc-content, .content').forEach((content) => {
