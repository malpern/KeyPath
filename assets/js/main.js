...
(function() {
    ...
    if (document.body.classList.contains('parchment-theme')) {
        document.querySelectorAll('.kp-doc-body blockquote, .doc-content blockquote, .content blockquote').forEach(bq => {
...
`;
    ...
    document.querySelectorAll('.kp-doc-body, .doc-content, .content').forEach((content) => {
