...
assert_contains "$layout_html" '<div class="kp-article' \
  "layout must use .kp-article as canonical docs container"
...
assert_contains "$js_source" '\.kp-article' \
  "main JS should target .kp-article selectors for docs behavior"
