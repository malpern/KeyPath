...
See [distributed-notifications.md](distributed-notifications.md), [app-intents.md](../guides/app-intents.md), and [action-uri-system.md](../guides/action-uri-system.md).
