...
- Generated: 2026-03-17 15:25:11Z
- Exact entries: 1999 (-9 vs previous manifest)
...
- `CB10:1133` omitted because `qmk:crkbd/rev1` disagrees with `via:keebio/bdn9/bdn9-rev1`
- `CB10:1256` omitted because `qmk:crkbd/rev4_0/standard` disagrees with `via:keebio/iris/iris-rev1`
- `1209:2303` omitted because `qmk:boardsource/unicorne` disagrees with `via:keyboardio/atreus`
- `FC32:1287` omitted because `qmk:ferris/sweep` disagrees with `via:sofle/keyhive_sofle_rgb`
- `3297:1969` omitted because `qmk:keebio/iris/rev4` disagrees with `via:zsa/moonlander`

## VIA Duplicate VID:PID Collisions

- `3434:0330` -> ansi, keychron/v3/ansi
- `3434:0331` -> ansi_encoder, keychron/v3/ansi_encoder
- `3434:0332` -> iso, keychron/v3/iso
- `3434:0333` -> iso_encoder, keychron/v3/iso_encoder
- `3434:0334` -> jis, keychron/v3/jis
- `3434:0335` -> jis_encoder, keychron/v3/jis_encoder
