---
layout: default
title: "Press Two Keys at Once"
description: "Press two adjacent keys simultaneously to produce Escape, Enter, Backspace, or any other key without leaving the home row"
theme: parchment
header_image: header-chords.png
permalink: /guides/chords/
---
...
![Screenshot]({{ '/images/help/chords-collection-view.png' | relative_url }})
...
- **Combine with home row mods** — Chords and [home row mods]({{ '/guides/home-row-mods/' | relative_url }}) complement each other: HRM gives you modifiers, chords give you editing keys
...
- **[Shortcuts Without Reaching]({{ '/guides/home-row-mods/' | relative_url }})** — Combine chords with home row modifiers for a complete home-row setup
- **[One Key, Multiple Actions]({{ '/guides/tap-hold/' | relative_url }})** — Tap-hold for keys that need two roles
- **[What You Can Build]({{ '/guides/use-cases/' | relative_url }})** — See chords as part of a full keyboard workflow
