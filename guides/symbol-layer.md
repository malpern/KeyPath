---
layout: default
title: "Programming Symbols Instantly"
description: "Brackets, pipes, and operators all under your home row. Three preset layouts for different coding styles."
theme: parchment
header_image: header-symbol-layer.png
permalink: /guides/symbol-layer/
---
...
- **[Navigate Text Like a Keyboard Ninja]({{ '/guides/vim-navigation/' | relative_url }})** — The foundation layer (required for symbols)
- **[Choose Your Leader Key]({{ '/guides/leader-key/' | relative_url }})** — Change which key starts the activation
- **[Symbols Without Shift]({{ '/guides/auto-shift/' | relative_url }})** — An alternative approach: hold symbol keys longer for shifted variants
- **[Keyboard Concepts]({{ '/guides/concepts/' | relative_url }})** — Background on layers and presets
