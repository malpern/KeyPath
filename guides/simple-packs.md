...
layout: default
title: "Quick Tweaks"
description: "Simple on/off packs: Escape remap, delete enhancement, backup Caps Lock, and Mission Control shortcuts"
theme: parchment
header_image: header-concepts.png
permalink: /guides/simple-packs/
---
...
| Preset | What it does |
|--------|-------------|
| **Caps Lock** (default) | Caps Lock sends Escape |
| **Backtick** | Backtick (`` ` ``) sends Escape |
| **Tab** | Tab sends Escape |

> **Tip:** If you're using [home row mods]({{ '/guides/home-row-mods/' | relative_url }}), the Caps Lock Remap pack already gives you Escape on tap + Hyper on hold — you may not need this pack.
...
| Preset | What it does |
|--------|-------------|
| **Forward Delete** | Delete key on the navigation layer |
| **Delete Word** | Option+Backspace on the navigation layer |
| **Delete Line** | Cmd+Backspace on the navigation layer |
...
| Preset | What it does |
|--------|-------------|
| **Both Shifts** (default) | Press Left Shift + Right Shift together to toggle Caps Lock |
| **Double-tap Escape** | Tap Escape twice quickly to toggle Caps Lock |
...
| Key | Action |
|-----|--------|
| `M` | Mission Control (Expose) |
| `Q` | Show all windows for current app |
| `T` | Show Desktop |
...
## Enabling These Packs

1. Open KeyPath and click the gear icon to open the inspector panel
2. Go to the **Rules** tab
3. Find the pack by name and toggle it **on**
4. If prompted, choose your preferred option
...
- **[Keyboard Concepts]({{ '/guides/concepts/' | relative_url }})** — Background on layers and dual-role keys
- **[Shortcuts Without Reaching]({{ '/guides/home-row-mods/' | relative_url }})** — Home row modifiers for a complete setup
- **[What You Can Build]({{ '/guides/use-cases/' | relative_url }})** — See these packs as part of a full workflow
