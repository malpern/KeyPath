...
description: "Map your Karabiner knowledge to KeyPath concepts"
theme: parchment
header_image: header-karabiner-users.png
permalink: /guides/karabiner-users/
---
...
Follow the [Installation guide]({{ "/guides/installation/" | relative_url }}). KeyPath's wizard handles permissions and driver setup.
