---
layout: default
title: "Neovim in the Terminal"
description: "Bring Neovim navigation muscle memory to every macOS app with a Leader-layer HUD reference"
theme: parchment
header_image: header-neovim-terminal.png
permalink: /guides/neovim-terminal/
---
...
- If you use both Neovim and regular macOS apps, this collection is for you. For deeper KindaVim modal editing integration, see [KindaVim Integration]({{ '/guides/kindavim/' | relative_url }}).
- The Leader key defaults to Space. Change it in the **Leader Key** collection in the Rules tab.

## Next Steps

- **[KindaVim Integration]({{ '/guides/kindavim/' | relative_url }})** — Full modal editing (Normal/Insert/Visual) system-wide
- **[Press Two Keys at Once]({{ '/guides/chords/' | relative_url }})** — Chords complement vim navigation
- **[What You Can Build]({{ '/guides/use-cases/' | relative_url }})** — See vim navigation as part of a complete keyboard workflow
