...
- If you use both Neovim and regular macOS apps, this collection is for you. For deeper KindaVim modal editing integration, see [Full Vim Modes]({{ '/guides/kindavim/' | relative_url }}).
